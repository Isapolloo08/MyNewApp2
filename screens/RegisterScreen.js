                    ...
                    <View style={styles.inputContainer}>
                        ...
                        >
                            <View style={styles.modalBackground}>
                                <View style={styles.modalContainer}>
                                    <FlatList
                                        data={['Farmer', 'Fisherman', 'Housewife', 'Driver', 'Laborer', 'Vendor', 'Security Guard', 'Nurse', 'Teacher', 'Engineer', 'Office Worker', 'Unemployed', 'Other']}
                                        renderItem={({ item }) => (
                                            <TouchableOpacity
                                                style={styles.dropdownItem}
            ...
            {currentPage === 2 && (
                <>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Enter Last Menstrual Period (LMP)"
                            value={lmp}
                            onChangeText={setLmp}
                        />
                    </View>
